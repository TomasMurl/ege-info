...
# ======================
voltage = [23.118, 38.227, 44.807, 45.398, 42.961, 40.086, 33.383, 31.934, 36.45]
current = [0.4, 0.7, 0.9, 1, 1.08, 1.14, 1.18, 1.21, 1.24, 1.28, 1.3, 1.34, 1.36, 1.4, 1.42]
...
ax2.plot(current, angles, 'o-', label='График угла от тока', color='purple', linewidth=2, markersize=6)
ax2.scatter([current_at_angle0], [angle_target], color='red', s=100, zorder=5,
            label=f'Угол 0° → I ≈ {current_at_angle0:.2f} А')
ax2.set_title('График угла от тока', fontsize=12)
ax2.set_xlabel('Ток (А)', fontsize=10)
ax2.set_ylabel('Угол (градусы)', fontsize=10)
